...
<body id="mobile_wrap">
  ...
  <div class="panel panel-left panel-reveal">
    <nav class="sidebar-nav">
      <ul>
          <li><a href="shop.html" class="close-panel"><img src="/resources/images/icons/black/shop.png" alt=""/><span>매장소개</span></a></li>
          <li><a href="account.html" class="close-panel"><img src="/resources/images/icons/black/users.png"/><span>내 정보</span></a></li>
          <li><a href="event_list.html" class="close-panel"><img src="/resources/images/icons/black/gift.png"/><span>이벤트</span></a></li>
          <li><a href="about.html" class="close-panel"><img src="/resources/images/icons/black/super.png"/><span>키즈카페 소개</span></a></li>
          <li><a href="food.html" class="close-panel"><img src="/resources/images/icons/black/shop.png"/><span>메뉴안내</span></a></li>
          <li><a href=""><img src="/resources/images/icons/black/food.png"/><span>티켓구입(준비중)</span></a></li>
          <li><a href="contact.html" class="close-panel"><img src="/resources/images/icons/black/contact.png"/><span>고객센터</span></a></li>
          <span style="font-size: 10px;"><center>©FunnyFlux/Alpha/EBS,SW3</center></span>
      </ul>
    </nav>
  ...
  <div class="panel panel-right panel-reveal">
    <div class="user_login_info">
      <div class="user_thumb">
        <div class="user_avatar"><img src="/resources/images/icons/white/entrance_on.png" alt="" title="" /></div>
        <div class="user_details">
          <p><br><br><span>홍길동</span><br><br>IN 영통점</p>
        </div>
        <div class="user_social"></div>
      </div>
      <nav class="user-nav">
        <ul>
          <li><a href=""><img src="/resources/images/icons/white/tables.png"/><span>2019-11-01</span></a></li>
          <li><a href=""><img src="/resources/images/icons/white/in.png"/><span>12:00</span><strong>5</strong></a></li>
          <li><a href=""><img src="/resources/images/icons/white/out.png"/><span>01:54</span></a></li>
        </ul>
      </nav>
    </div>
  </div>
              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide">
                  ...
                  <div class="slider-caption">
                    <h2 data-swiper-parallax="-100%">오픈안내</h2><br>
    ...
    <div class="content-block">
      ...
      <div class="loginform">
        <form id="LoginForm" method="post">
          <input type="number" min="11" max="11" inputmode="numberic" pattern="[0-9]*" name="Username" value="" class="form_input required" placeholder="휴대폰번호" />
          <input type="password" name="Password" value="" class="form_input remote" placeholder="비밀번호" />
          <div class="forgot_pass"><a href="#" data-popup=".popup-forgot" class="open-popup">비밀번호 찾기</a></div>
          <input type="submit" name="submit" class="form_submit" id="submit" value="로그인" />
        </form>
  ...
  <div class="popup popup-logout">
    <div class="content-block">
      ...
      <div class="loginform">
          <p>로그아웃을 진행합니다.</p>
        <form id="LoginForm" method="post">
          <input type="submit" name="submit" class="form_submit" id="submit" value="로그아웃" />
        </form>
      </div>
      <div class="close_popup_button">
        <a href="#" class="close-popup"><img src="/resources/images/icons/black/menu_close.png"/></a>
    ...
    <div class="content-block">
      <h4>고객전용 QR코드</h4>
              <div style="text-align:center;">
                <img src="/resources/images/icons/black/qrcode.png" alt=""><br>
                <h3>홍길동<span>고객님</span></h3>
                <p>고객번호:<span>M2019089930303</span></p><br>
              </div>
      <div class="close_popup_button">
        <a href="#" class="close-popup"><img src="/resources/images/icons/black/menu_close.png"/></a>
      </div>
    ...
    <div class="content-block">
      ...
      <div class="loginform">
        <form id="ForgotForm" method="post">
          <input type="number" minlength="11" inputmode="numberic" pattern="[0-9]*" name="Username" value=""
            class="form_input required" placeholder="ID는 휴대폰번호 (형식) 010XXXX0000" />
          <input type="text" name="Username" value="" class="form_input required" placeholder="고객님 성함" />
  ...
  <div class="popup popup-passwordchange">
    <div class="content-block">
      ...
      <div class="loginform">
        <form id="ForgotForm" method="post">
          <input type="password" name="Password" value="" class="form_input required" placeholder="현재의 비밀번호" />
          <input type="password" name="Password" value="" class="form_input required" placeholder="변경할 비밀번호" />
          <input type="password" name="Password" value="" class="form_input required" placeholder="비밀번호 확인" />
          <input type="submit" name="submit" class="form_submit" id="submit" value="비밀번호 변경요청" />
        </form>
        <div class="signup_bottom">
          <p>매장에서 포스에서 가입한 고객님의 <br><br>초기비밀번호는 1111 입니다.<br><br>비밀번호를 꼭 변경해 주세요.</p>
        </div>
        ...
        <div class="page_single layout_fullwidth_padding">
          ...
          <div class="popup popup-qrcode">
            <div class="content-block">
              <h4>고객전용 QR코드</h4>
              <div style="text-align:center;">
                <img src="/resources/images/icons/black/qrcode.png" alt="">
                <h3>홍길동<span>고객님</span></h3>
              </div>
              <div class="close_popup_button"><a href="#" class="close-popup"><img src="/resources/images/icons/black/menu_close.png" alt="" title="" /></a></div>
            </div>
          </div>
