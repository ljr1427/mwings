      ...
      <div class="page-content">
        <div class="navbarpages">
          <div class="navbar_left">
            <div class="logo_text"><a href="main"><span>가족</span>등록</a></div>
          </div>
            ...
            <div class="contactform">
              ...
              <div class="contactform">
                ...
                <form class="cmxform" id="ContactForm" method="post" action="">
                  ...
                  <input type="text" name="SignName1" id="ContactEmail" value="" class="form_input required"
                    placeholder="성함입력(실명)" />
                </form>
                <form class="cmxform" id="ContactForm" method="post" action="">
                  <label>가족2</label>
                  ...
                  <input type="text" name="SignName2" id="ContactEmail" value="" class="form_input required"
                    placeholder="성함입력(실명)" />
                </form>
                <form class="cmxform" id="ContactForm" method="post" action="">
                  <label>가족3</label>
                ...
                <br><br><br>
                <a href="success" class=" button_full">등록완료</a>
              </div>
            </div>
          </div>
        </div>
